...
- I learned how to utilize github desktop that helped me use visual studio code in a easier process.

**I struggled with:** (repeat as needed)
-  I struggled to add descriptive message before commiting.
...
- Mr.Dang when I could not get into the classroom 50.
